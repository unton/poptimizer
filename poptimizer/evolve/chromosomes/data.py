...
from poptimizer.config import HISTORY_DAYS_MIN, YEAR_IN_TRADING_DAYS, MONTH_IN_TRADING_DAYS
...
HISTORY_DAYS = GeneParams(
    name="history_days",
    default_range=(YEAR_IN_TRADING_DAYS, YEAR_IN_TRADING_DAYS + MONTH_IN_TRADING_DAYS),
