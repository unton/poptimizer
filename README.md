...
- дождаться первого ночного обновления данных (0:45 MSK). Программа удалит из списка доступных малоликвидные бумаги с короткой историей и нулевой позицией на всех счетах, а так же внесенные в список исключений
